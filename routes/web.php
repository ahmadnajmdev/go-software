...
// Project detail pages. Registered after the archive so /projects still wins.
Route::get('/projects/{slug}', ProjectController::class)->name('project');
Route::get('/{locale}/projects/{slug}', ProjectController::class)
    ->where('locale', 'ar|ckb')->name('project.locale');

      ...
      @foreach ($testimonials as $testimonial)
        <div data-item-id="{{ $testimonial->id }}" data-item-model="testimonials" style="background: #fff; border-radius: var(--gs-r-card, 16px); padding: 32px; border: 1px solid #eaefef;">
          ...
          <div style="display: flex; align-items: center; gap: 14px;">
            <img src="{{ media_url($testimonial->avatar) }}" @auth data-edit-image data-image-field="avatar" @endauth style="width: 50px; height: 50px; border-radius: 50%; object-fit: cover;">
